...
5. Set VITE_KINEVA_ENABLED=true locally for a controlled preview. In Studio choose
...
| Job contract | Two migrations, Edge Function, worker and synthetic two-shot FFmpeg assembly pass local checks; no cloud mutation yet. |
